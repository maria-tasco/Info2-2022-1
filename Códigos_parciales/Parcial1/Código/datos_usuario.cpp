...
void mostrar_usuarios(datos_funciones_usuario *usuarios, unsigned int *ptr_nU)
{
    for(unsigned int i=1;i<*ptr_nU;i++){
        cout<<usuarios[i].usuario->nombre_apellidos<<endl;
        cout<<usuarios[i].usuario->d_i<<endl;
        cout<<usuarios[i].usuario->num_cel<<endl;
        cout<<usuarios[i].usuario->edad<<endl;
        cout<<usuarios[i].usuario->vocacion<<endl;
